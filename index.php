...
<body>
    ...
    <div class="container mt-4">
            ...
            <div class="col-lg-12 ">
                <div class="">
                    <div class="main-heading  d-flex align-items-center justify-content-center">
                        ...
                        <p class="mb-0 pb-0">LotteryLand.<span>io</span></p>
                    </div>
                    <div class="main-text mt-4">
                        <h3 class=" d-flex">Welcome to<p class="mb-0 mx-2"> Lotteryland<span>!</span></p>
                        </h3>
                        <p class="mb-0 text"> You are in the land where you can win many prizes! Every day we will have
                            many giveaways! Choose one of the three draws, buy your ticket and when the quota is
                            completed, the system will automatically make the draw and publish the winner's wallet, and
                            your prize will arrive!
                            Start playing right now at Lotteryland!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mt-4">
                <div class="card pack">
                    <div class="card-body pack-body">
                        <div class="pack-img">
                            <img src="images/briefcase.png" alt="" class="img-fluid">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 mt-4">
                <div class="card pack2">
                    <div class="card-body pack-body">
                        <div class="pack-img">
                            <img src="images/piggy-bank (1).png" alt="" class="img-fluid">
                        </div>
                        <div class="pack-price d-flex align-items-center justify-content-center">
                            <h2>Lotteryland</h2>
                            <h3 class="mx-3">5K</h3>
            ...
            <div class="col-lg-4 col-md-12 mt-4">
                <div class="card pack">
                    <div class="card-body pack-body">
                        <div class="pack-img">
                            <img src="images/best-employee.png" alt="" class="img-fluid">
                        </div>
                        <div class="pack-price d-flex align-items-center justify-content-center">
        ...
        <div class="row d-flex justify-content-center ">
            <div class="col-lg-12 mt-5">
                <div class="banner ">
                    <div class="banner__text text-center order2">
                        <p class="mb-0 banner-text">When each Lottery is complete, the system will give us the <span
                                class="mx-2">winner!</span></p>
                        <span class="mx-auto">Buy your ticket right now!</span>
                    </div>
                    <img src="images/trophy.png" alt="" class="img-fluid order1">
                </div>
            </div>
        </div>

        <div class="text-center  mt-2">
            <small class="text-white">We charge the ticket + our commission of 10% of the ticket value. That is, the
                value of the trip divided by 100, and that value + 10% of our commission.</small>
        </div>
